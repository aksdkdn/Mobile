...
class CalendarAdapter extends RecyclerView.Adapter<CalendarViewHolder>
{
    ...
    public CalendarAdapter(ArrayList<ExerciseData> data,ArrayList<String> daysOfMonth, OnItemListener onItemListener)
    {
    ...
    public void onBindViewHolder(@NonNull CalendarViewHolder holder, int position)
    {
        ...
        for(int i = 0; i < exerciseData.size(); i++){
            if(exerciseData.get(i).getDate().substring(8,10).equals(daysOfMonth.get(position))){
