...
public class CableReizeActivity extends AppCompatActivity {
    ...
    private int[] imageResources = {R.drawable.cablereize1, R.drawable.cablereize2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cablereize);
                ...
                if (currentRepetition <= totalRepetitions) {
                    ...
                    if (currentSet < totalSets) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                // 여기에서 새로운 레이아웃으로 전환하는 코드를 추가
                                startActivity(new Intent(CableReizeActivity.this, OverHeadActivity.class));
                                finish(); // 현재 액티비티 종료
                            }
