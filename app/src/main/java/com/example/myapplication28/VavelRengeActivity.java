...
public class VavelRengeActivity extends AppCompatActivity {
    ...
    private int[] imageResources = {R.drawable.vavelrenge1, R.drawable.vavelrenge2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vavelrenge);
                ...
                if (currentRepetition <= totalRepetitions) {
                    ...
                    if (currentSet < totalSets) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                // 여기에서 새로운 레이아웃으로 전환하는 코드를 추가
                                startActivity(new Intent(VavelRengeActivity.this, VavelRengeActivity.class));
                                finish(); // 현재 액티비티 종료
                            }
