...
public class DumbelRowActivity extends AppCompatActivity {
    ...
    private int[] imageResources = {R.drawable.dumbelrow1, R.drawable.dumbelrow2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dumbelrow);
                ...
                if (currentRepetition <= totalRepetitions) {
                    ...
                    if (currentSet < totalSets) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                // 여기에서 새로운 레이아웃으로 전환하는 코드를 추가
                                startActivity(new Intent(DumbelRowActivity.this, DumbelRowActivity.class));
                                finish(); // 현재 액티비티 종료
                            }
