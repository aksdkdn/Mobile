...
public class VenchActivity extends AppCompatActivity {
    ...
    private int[] imageResources = {R.drawable.vench1, R.drawable.vench2};
                ...
                if (currentRepetition <= totalRepetitions) {
                    ...
                    if (currentSet < totalSets) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                // 여기에서 새로운 레이아웃으로 전환하는 코드를 추가
                                startActivity(new Intent(VenchActivity.this, InclineActivity.class));
                                finish(); // 현재 액티비티 종료
                            }
