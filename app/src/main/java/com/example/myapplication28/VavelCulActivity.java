...
public class VavelCulActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vavelcul);
        ...
        // 운동 가이드 버튼에 대한 클릭 리스너 등록
        Button guideButton = findViewById(R.id.guideButton);
        guideButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(VavelCulActivity.this, VavelCulExActivity.class));
            }
        });
                ...
                if (currentRepetition <= totalRepetitions) {
                    ...
                    if (currentSet < totalSets) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                // 여기에서 새로운 레이아웃으로 전환하는 코드를 추가
                                startActivity(new Intent(VavelCulActivity.this, CableBicepCurlActivity.class));
                                finish(); // 현재 액티비티 종료
                            }
